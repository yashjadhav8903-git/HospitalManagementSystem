...
1 . Add new doctor<br>
2 .View doctor list<br>
3 .Update doctor details<br>



🧑‍⚕️ Patient Management.

1 .Add new patient<br>
2 .View patient list<br>
3 .Update patient details<br>
...
2 .View all appointments<br>
3 .Automatic validation of IDs<br>
...
1 .Java (Core Java, OOP, Exception Handling)<br>
2 .JDBC PostgreSQL<br>
3 .DAO Pattern<br>
4 .IntelliJ IDEA<br>
...
1 . Clone this repository to your local machine
        ...
        https://github.com/yashjadhav8903-git/HospitalManagementSystem.git    
